...
const columns = [
  ...
  { field: "declarationType", headerName: "Declaration Type", width: 250 },
...
// start edit
  ...
  const fetchData = async (requestData) => {
    try {
      ...
      console.log("check main Ex203 Deductible ",response.data.data);
...
export default Form_EX203_Deductible;
